        ...
        <el-aside style="width:270px;border:2px solid silver;height:100%;">
          <div style="height:35%;overflow:auto;">
            ...
            <el-tree
              ...
              <span class="custom-tree-node" slot-scope="{ node,data }">
                <span style="margin-left:5px" @click="handleLayerClick(node)"> 
          ...
          <div style="height:65%;"> 
            <el-tabs type="border-card" style="height:100%;">
              <el-tab-pane label="点编辑" style="display:none;" :class="{ ptShow : this.curLayerId == this.ptId ,ptHide : this.curLayerId != this.ptId}" >
                <el-switch
                  v-model="addPoint"
                  active-text=""
                  inactive-text="添加点">
         ...
         ;background-color:silver;height:40px;border-bottom-right-radius: 4px;border-top-right-radius: 4px;" @click = "handleTreeVis">
